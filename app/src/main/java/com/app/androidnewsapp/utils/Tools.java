...
import com.app.androidnewsapp.activities.ActivityNotificationDetail;
import com.app.androidnewsapp.activities.ActivityWebView;
import com.app.androidnewsapp.activities.ActivityWebViewImage;
...
public class Tools {
    ...
    public static void blackNavigation(Activity activity) {
        activity.getWindow().setNavigationBarColor(ContextCompat.getColor(activity, R.color.colorBlack));
        activity.getWindow().setStatusBarColor(ContextCompat.getColor(activity, R.color.colorBlack));
        activity.getWindow().getDecorView().setSystemUiVisibility(0);
    }
