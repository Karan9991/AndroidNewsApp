...
import static com.app.androidnewsapp.utils.Constant.BANNER_POST_DETAIL;
import static com.app.androidnewsapp.utils.Constant.INTERSTITIAL_POST_DETAIL;
import static com.app.androidnewsapp.utils.Constant.NATIVE_AD_POST_DETAIL;
...
import com.app.androidnewsapp.adapter.AdapterRelated;
import com.app.androidnewsapp.callbacks.CallbackPostDetail;
...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    private void displayImages(final List<Images> images) {
        ...
        AdapterImageDetail adapter = new AdapterImageDetail(this, images);
    ...
    public void addToFavorite() {
        List<Post> data = dbHandler.getFavRow(nid);
        if (data.size() == 0) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_later:
                ...
                if (data.size() == 0) {
                    ...
                    if (data.get(0).getNid() == nid) {
                        dbHandler.RemoveFav(new Post(nid));
