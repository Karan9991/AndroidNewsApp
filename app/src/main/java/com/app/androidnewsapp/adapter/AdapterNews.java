...
import static com.app.androidnewsapp.utils.Constant.NATIVE_AD_POST_LIST;
...
public class AdapterNews extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterNews(Context context, RecyclerView view, List<Post> posts) {
        this.posts = posts;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            if (AppConfig.BIG_NEWS_LIST_STYLE) {
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lsv_item_news_big, parent, false);
            } else {
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lsv_item_news, parent, false);
            }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            String nativeStyles;
            if (AppConfig.BIG_NEWS_LIST_STYLE) {
                nativeStyles = "default";
            } else {
                nativeStyles = Constant.NATIVE_AD_STYLE;
            }
            ...
            if (!Constant.NATIVE_AD_STYLE.equals("news") || AppConfig.BIG_NEWS_LIST_STYLE) {
